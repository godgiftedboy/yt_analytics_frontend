  ...
  return (
    <div className="bg-[#2c2e3d] h-[600px] overflow-y-scroll p-16">
      <div className="flex flex-col gap-10">
        ...
        <div className="text-white text-[14]">We used {modelUsed === 'model1'? 'Support Vector Machine': 'Naive Bayes' } Model trained with sentiment labelled dataset containing 24,427 comments collected from kaggle. </div>
        <div className="text-white text-[14]"> The Performance evaluation metrices presented below in the diagrams are computed for the result obtained for test dataset having 3224 samples. </div>
